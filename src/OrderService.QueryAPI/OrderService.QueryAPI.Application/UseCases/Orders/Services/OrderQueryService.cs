...
public class OrderQueryService : IOrderQueryService
{
    ...
    public async Task<ApiResponse<OrderResponseDto>> GetOrderByIdAsync(Guid id, CancellationToken cancellationToken = default)
    {
        ...
        if (order is null)
            return ApiResponse<OrderResponseDto>.Fail(new List<string> { "Order not found" }, "Not Found");
    ...
    public async Task<ApiResponse<List<OrderResponseDto>>> GetAllOrdersAsync(CancellationToken cancellationToken = default)
    {
